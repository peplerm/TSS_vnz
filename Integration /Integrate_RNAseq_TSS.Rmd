...
We are also interested in characterizing whether these TSSs correspond to the transcription of a true ncRNA or long 5' UTR (all we know currently is that they are >250bp upstream of a gene). 

It will take several steps to answer this: 

1) Filter the TSS .bed file by those TSSs which are deferentially expressed in the RNA-sequencing data-set 

2) Use the bedtools closest function, to call the nearest downstream gene and the distance between the gene and TSS 
